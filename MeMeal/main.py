...
def handle_input(user_input):
    ...
    edamam_app_id = "0b869b6e"
    edamam_app_key = "0fc4ba27d32e04a4912d10e0fae86165"
    ...
    recipe = generate_recipe(dietary_restrictions, allergies, query, edamam_data)
    return recipe
